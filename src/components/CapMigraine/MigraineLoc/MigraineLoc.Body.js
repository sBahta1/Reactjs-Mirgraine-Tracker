        ...
        return (
            <Paper >
                <List dense >
                    <ListItem dense>
                        <Switch
                            checked={this.state.back_upper}
                            onChange={this.handleChange('back_upper')} />
                        <ListItemText primary="Upper Back" />
                    </ListItem>
                    <ListItem dense>
                        <Switch
                            value="back_mid"
                            checked={this.state.back_mid}
                            onChange={this.handleChange('back_mid')} />
                        <ListItemText primary="Mid Back" />
                    </ListItem>
                    <ListItem dense>
                        <Switch
                            value="back_lower"
                            checked={this.state.back_lower}
                            onChange={this.handleChange('back_lower')} />
